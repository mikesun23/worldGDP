package com.nilangpatel.worldgdp.test.config.dao;
...
public class CityDAOTest {
	...
	@Autowired CityDAO cityDao; // wireup testing class/object/component
	
	@Autowired @Qualifier("testTemplate") // wireup testing DBconfiguration class
	NamedParameterJdbcTemplate namedParamJdbcTemplate; // Template from TestDBConfiguration
